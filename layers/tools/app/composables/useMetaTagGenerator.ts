...
const presets: MetaTagPreset[] = [
  ...
  },
  {
    ...
    values: {
      title: 'Premium Wireless Headphones - $99 | TechStore',
      ...
      ogTitle: 'Premium Wireless Headphones - Now $99',
      ogDescription: 'Crystal-clear audio, 40hr battery, ANC. Free shipping on orders over $50.',
      ogImage: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=1200&h=630&fit=crop',
      ogImageAlt: 'Premium wireless headphones on wooden surface',
      ogImageWidth: '1200',
      ogImageHeight: '630',
      ogType: 'product',
      ogUrl: 'https://techstore.example.com/products/wireless-headphones',
      ogSiteName: 'TechStore',
      ogLocale: 'en_US',
      twitterCard: 'summary_large_image',
      twitterSite: '@techstore',
      twitterCreator: '@techstore',
      twitterImage: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=1200&h=600&fit=crop',
      author: 'TechStore',
      canonical: 'https://techstore.example.com/products/wireless-headphones',
  ...
  },
  {
    ...
    values: {
      title: 'Build Apps 10x Faster | Launchpad',
      description: 'The all-in-one platform for building, deploying, and scaling your web applications. Start free, scale infinitely. Join 50,000+ developers.',
      ogTitle: 'Launchpad - Build Apps 10x Faster',
      ogDescription: 'Ship faster with our all-in-one platform. From idea to production in minutes. Start free today.',
      ogImage: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&h=630&fit=crop',
      ogImageAlt: 'Team collaborating on laptops in modern office',
      ogImageWidth: '1200',
      ogImageHeight: '630',
      ogType: 'website',
      ogUrl: 'https://launchpad.example.com',
      ogSiteName: 'Launchpad',
      ogLocale: 'en_US',
      twitterCard: 'summary_large_image',
      twitterSite: '@launchpad',
      twitterCreator: '@launchpad',
      twitterImage: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&h=600&fit=crop',
      author: 'Launchpad Team',
      canonical: 'https://launchpad.example.com',
      robots: 'index, follow, max-image-preview:large',
      twitterLabel1: 'Developers',
      twitterData1: '50,000+',
      twitterLabel2: 'Free tier',
      twitterData2: 'Available',
      themeColor: '#6366f1',
      colorScheme: 'light dark',
      applicationName: 'Launchpad',
      fbAppId: '987654321098765',
    },
  },
  {
    id: 'docs',
    ...
    values: {
      title: 'Getting Started - Unhead Documentation',
      description: 'Learn how to install, configure, and use Unhead in your project. Step-by-step guide with examples and API reference.',
      ogTitle: 'Getting Started | Unhead Docs',
      ogDescription: 'Complete installation guide for Unhead. Set up in under 5 minutes with Vue, React, or vanilla JS.',
      ogImage: 'https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?w=1200&h=630&fit=crop',
      ogImageAlt: 'Documentation and code snippets on screen',
      ogImageWidth: '1200',
      ogImageHeight: '630',
      ogType: 'website',
      ogUrl: 'https://unhead.example.com/docs/getting-started',
      ogSiteName: 'Unhead',
      ogLocale: 'en_US',
      twitterCard: 'summary',
      twitterSite: '@unaboratory',
      twitterCreator: '@harlodev',
      author: 'Unhead Team',
      canonical: 'https://unhead.example.com/docs/getting-started',
      robots: 'index, follow, max-snippet:-1',
      twitterLabel1: 'Category',
      twitterData1: 'Documentation',
      twitterLabel2: 'Updated',
      twitterData2: 'Jan 2024',
      themeColor: '#10b981',
      colorScheme: 'light dark',
      applicationName: 'Unhead',
    },
  },
]
