...
import { blueprintAd } from '~/utils/ads'

const possibleAds = computed(() => {
  return [{ id: 'blueprint', enabled: blueprintAd.value }].filter(v => v.enabled)
})
// shuffle
const ad = computed(() => {
      ...
      <template v-if="ad">
        ...
        >
          ...
          <ul class="px-1 list-disc text-sm ml-4 space-y-1 mb-3">
            ...
            <li>By sponsor of Unhead Danny Postma</li>
          </ul>
          <div class="px-1">
