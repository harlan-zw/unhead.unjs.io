...
const schemaTypes: SchemaTypeConfig[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'question1', label: 'Question 1', type: 'text', placeholder: 'What is your product?', default: 'What is Schema.org?', required: true, help: 'At least one Q&A is required.' },
      { key: 'answer1', label: 'Answer 1', type: 'textarea', placeholder: 'Our product is...', default: 'Schema.org is a collaborative vocabulary for structured data that helps search engines understand your content.', required: true },
  ...
  },
  {
    ...
    fields: [
      { key: 'name', label: 'Business Name', type: 'text', placeholder: 'My Coffee Shop', default: 'The Daily Grind Coffee House', required: true, help: 'Required for rich results.' },
      ...
      { key: 'image', label: 'Image URL', type: 'url', placeholder: 'https://example.com/shop.jpg', default: 'https://example.com/coffee-shop.jpg', help: 'Recommended for rich results.' },
      ...
      { key: 'streetAddress', label: 'Street Address', type: 'text', placeholder: '123 Main St', default: '123 Main Street', required: true, help: 'Required for rich results.' },
      { key: 'addressLocality', label: 'City', type: 'text', placeholder: 'San Francisco', default: 'San Francisco', required: true, help: 'Required for rich results.' },
      ...
      { key: 'addressCountry', label: 'Country', type: 'text', placeholder: 'US', default: 'US', required: true, help: 'Required for rich results.' },
      { key: 'priceRange', label: 'Price Range', type: 'text', placeholder: '$$', default: '$$', help: 'Recommended. Use $ to $$$$ scale.' },
    ],
  },
  {
    type: 'Organization',
  ...
  },
  {
    ...
    fields: [
      { key: 'name', label: 'Title', type: 'text', placeholder: 'How to Make Coffee', default: 'How to Set Up a Vue.js Project', required: true, help: 'Required for rich results.' },
      { key: 'description', label: 'Description', type: 'textarea', placeholder: 'Learn how to brew...', default: 'A step-by-step guide to creating your first Vue.js application.', help: 'Recommended for rich results.' },
      { key: 'image', label: 'Image URL', type: 'url', placeholder: 'https://example.com/howto.jpg', help: 'Recommended for rich results.' },
      { key: 'totalTime', label: 'Total Time', type: 'text', placeholder: 'PT30M', default: 'PT15M', help: 'Recommended. ISO 8601 duration (e.g., PT30M for 30 minutes)' },
      { key: 'step1Name', label: 'Step 1 Name', type: 'text', placeholder: 'Gather materials', default: 'Install Node.js', required: true, help: 'At least one step is required.' },
      { key: 'step1Text', label: 'Step 1 Instructions', type: 'textarea', placeholder: 'Collect coffee beans...', default: 'Download and install Node.js from the official website.', required: true },
