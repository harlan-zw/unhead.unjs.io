      ...
      >
        ...
        <div class="flex items-center gap-3 mt-3 text-sm text-dimmed flex-wrap">
          <UBadge color="neutral" variant="outline">
            <!-- eslint-disable-next-line harlanzw/link-no-underscores -->
            <NuxtLink to="https://x.com/harlan_zw" external target="_blank" class="inline-flex items-center gap-1.5">
              <img alt="" src="https://avatars.githubusercontent.com/u/5326365?v=4" width="16" height="16" decoding="async" class="w-4 h-4 rounded-full">
